...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            return interaction.reply({ content: `✅ Leveling has been **${enabled ? "enabled" : "disabled"}**.`, flags: 64 });

        } catch (error) {
            console.error("Error toggling leveling system:", error);
            return interaction.reply({ content: "❌ An error occurred while updating the leveling system.", flags: 64 });
        }
    },
};
