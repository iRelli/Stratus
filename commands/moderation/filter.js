...
module.exports = {
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addBooleanOption(option =>
                    option.setName("enabled").setDescription("Enable or disable filtering.").setRequired(true)
                )
        )
        .addSubcommand(subcommand =>
            subcommand
    ...
    async execute(interaction) {
        ...
        if (subcommand === "toggle") {
            ...
            return interaction.reply({ content: `✅ Message filtering has been **${enabled ? "enabled" : "disabled"}**.`, flags: 64 });
        }
        ...
        if (subcommand === "level") {
            ...
            await moderationData.save();
            return interaction.reply({ content: `✅ Message filter level set to **${level.toUpperCase()}**.`, flags: 64 });
        }
    },
};
