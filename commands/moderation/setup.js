    ...
    async execute(interaction) {
        try {
            ...
            if (subcommand === "create") {
                ...
                let logChannel = guild.channels.cache.get(moderationData.logChannelId) ||
                ...
                return interaction.reply({ content: `✅ **Moderation log channel set up successfully:** ${logChannel}`, flags: 64 });
            }
